#!/usr/bin/env python3
"""
AI-Assistant Ready Context Generator 3.0
...
MAX_FILE_SIZE = 500 * 1024  # 500 KB per file (reduced to fit more files)
# Maximum number of lines per file
MAX_LINES = 3000  # Reduced to allow more files to fit
# Maximum total size of the final output file (bytes)
MAX_TOTAL_SIZE = 40 * 1024 * 1024  # 10 MB total output limit (typical AI assistant limit)
...
def generate_context(project_path, output_file):
    ...
    contents (plus some metadata) into a single Markdown file.
    """
...
def main():
    ...
    generate_context(args.project_path, args.output_file)
